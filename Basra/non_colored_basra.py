...
def combinational_basra(ground, card):
    try:
...
def is_comey_basra(ground, card='7c'):
    ...
    for c in integers:
        if direct_basra(ground, c):
            return True
        if combinational_basra(ground, c):
            return True
    return False
...
def single_hand(ground, chosen_card):
    ...
    elif direct_basra(g, chosen_card) or combinational_basra(g, chosen_card):
        cards += len(g) + 1
        score += 10
        g.clear()
    ...
    while (first_score < foura and second_score < foura) or (first_score == second_score):
        ...
        for _ in range(6):
            ...
            for _ in range(4):
                ...
                second_score += score
                print('computer card: ', chosen_card_second)
                if score == 10:
                    print('basra!')
                elif score == 30:
                    print('basra with jake!')
            ...
            print('First player cards = {}, and his score = {}'.format(first_cards_sum, first_score))
            print('Computer cards = {}, and his score = {}'.format(second_cards_sum, second_score))
        ...
        print('Final first player cards = {}, and his final score = {}'.format(first_cards_sum, first_score))
        print('Final computer cards = {}, and his final score = {}'.format(second_cards_sum, second_score))
