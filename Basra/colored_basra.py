...
def instructions():
    print(f"{Colors.blue}Your cards are blue{Colors.ENDC}")
    print(f"{Colors.red}Computer card is red{Colors.ENDC}")
    print(f"{Colors.green}Ground cards are green{Colors.ENDC}")
    print(f"{Colors.yellow}Game status are yellow{Colors.ENDC}")
    print(f"{Colors.underline}To select a card choose its position (1, 2, 3 or 4){Colors.ENDC}")
    print()
...
def main():
    ...
    while (first_score < foura and second_score < foura) or (first_score == second_score):
        ...
        for _ in range(6):
            print(f"{Colors.green}{ground}{Colors.ENDC}")
            first_cards, deck = give_4_cards_each(deck)
            second_cards, deck = give_4_cards_each(deck)
            for _ in range(4):
                print(f"{Colors.blue}{first_cards}{Colors.ENDC}")
                while True:
                    try:
                ...
                second_score += score
                print(f"{Colors.red}{chosen_card_second}{Colors.ENDC}")
                if score == 10:
                    colored_basra('basra!')
                elif score == 30:
                    colored_basra('basra with jake!')
            ...
            print(f"{Colors.yellow}First player cards = {first_cards_sum}, and his score = {first_score}{Colors.ENDC}")
            print(f"{Colors.yellow}Computer cards = {second_cards_sum}, and his score = {second_score}{Colors.ENDC}")
        ...
        print(f"{Colors.yellow}Final first player cards = {first_cards_sum}, and his score = {first_score}{Colors.ENDC}")
        print(f"{Colors.yellow}Final computer cards = {second_cards_sum}, and his score = {second_score}{Colors.ENDC}")
